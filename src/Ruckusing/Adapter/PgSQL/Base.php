 ...
 * @link      https://github.com/ruckus/ruckusing-migrations
 */
class _PgSQL_Base extends Base implements AdapterInterface
{
    /**
     * Name of adapter
     *
    ...
    /**
     * Creates an instance of _PgSQL_Base
     *
...
SQL;
    ...
    {
        return "_PgSQL_Base, version " . $this->_version;
    }
